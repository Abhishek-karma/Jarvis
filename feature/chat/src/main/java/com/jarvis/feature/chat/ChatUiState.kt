...
data class ChatUiState(
    ...
    /** Canonical run state of the agent. */
    val runState: com.jarvis.core.agent.execution.AgentRunState = com.jarvis.core.agent.execution.AgentRunState.IDLE,
    /** Structured user-facing state explaining the current or final outcome. */
    val userFacingState: com.jarvis.core.agent.execution.UserFacingState? = null,
    /** Canonical execution result if run has completed. */
    val executionResult: com.jarvis.core.agent.execution.ExecutionResult? = null,
