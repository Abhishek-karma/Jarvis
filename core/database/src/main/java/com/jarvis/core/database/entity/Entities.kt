...
/**
 * Durable per-task operation ledger for tracking side effects and retry deduplication.
 * Each tool execution keyed by an idempotency key gets a row here to record execution
 * state, prevent concurrent duplicate execution, and recover from interrupted runs.
 */
@Entity(
...
data class OperationEntity(
    ...
    val status: String, // EXECUTING | SUCCEEDED | FAILED | UNKNOWN
    val resultJson: String? = null,
