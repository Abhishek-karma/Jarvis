...
class OpenAiCompatibleProviderTest {
    ...
    @Test
    fun `listModels returns models on 200 response`() =
        runTest {
    ...
    @Test
    fun `stored base URL ending in v1 never double-prefixes the version path`() =
        runTest {
    ...
    @Test
    fun `listModels fails on 401 unauthorized`() =
        runTest {
    ...
    @Test
    fun `listModels fails on 403 forbidden`() =
        runTest {
    ...
    @Test
    fun `listModels retries on 500 then fails after max attempts`() =
        runTest {
            repeat(3) {
    ...
    @Test
    fun `streamChat emits Done event at end of stream`() =
        runTest {
            val sseBody = javaClass.classLoader!!.getResource("fixtures/chat_stream.txt")!!.readText()
            mockServer.enqueue(
                MockResponse()
    ...
    @Test
    fun `streamChat emits Usage event with token counts`() =
        runTest {
            val sseBody = javaClass.classLoader!!.getResource("fixtures/chat_stream.txt")!!.readText()
            mockServer.enqueue(
                MockResponse()
    ...
    @Test
    fun `streamChat sends correct Authorization header`() =
        runTest {
            val sseBody = javaClass.classLoader!!.getResource("fixtures/chat_stream.txt")!!.readText()
            mockServer.enqueue(
                MockResponse()
    ...
    @Test
    fun `streamChat sends correct model in request body`() =
        runTest {
            val sseBody = javaClass.classLoader!!.getResource("fixtures/chat_stream.txt")!!.readText()
            mockServer.enqueue(
                MockResponse()
    ...
    @Test
    fun `streamChat includes system prompt when provided`() =
        runTest {
            val sseBody = javaClass.classLoader!!.getResource("fixtures/chat_stream.txt")!!.readText()
            mockServer.enqueue(
                MockResponse()
    ...
    @Test
    fun `streamChat emits Error event on HTTP failure`() =
        runTest {
            mockServer.enqueue(MockResponse().setResponseCode(500).setBody("Server Error"))
    ...
    @Test
    fun `streamChat emits ToolCallRequested from streamed tool_calls deltas`() =
        runTest {
    ...
    @Test
    fun `streamChat sends tools in the request body when available`() =
        runTest {
            val sseBody = javaClass.classLoader!!.getResource("fixtures/chat_stream.txt")!!.readText()
            mockServer.enqueue(
                MockResponse()
    ...
    @Test
    fun `streamChat round-trips assistant tool_calls and tool results in the body`() =
        runTest {
            val sseBody = javaClass.classLoader!!.getResource("fixtures/chat_stream.txt")!!.readText()
            mockServer.enqueue(
                MockResponse()
    ...
    @Test
    fun `think mode adds reasoning effort to the request body`() =
        runTest {
            val sseBody = javaClass.classLoader!!.getResource("fixtures/chat_stream.txt")!!.readText()
            mockServer.enqueue(
                MockResponse()
    ...
    @Test
    fun `no think mode omits reasoning effort from the request body`() =
        runTest {
            val sseBody = javaClass.classLoader!!.getResource("fixtures/chat_stream.txt")!!.readText()
            mockServer.enqueue(
                MockResponse()
